...
function getFetch(){
  ...
  fetch(url)
      ...
      .then(data => {
        ...
        potentialPet.isGoodCompanion()
        
        let decision = ''
        if (potentialPet.housepet){
          decision = `Pokemon small, light, and safe to have as companion. You can catch ${potentialPet.name} in the following location(s):`
...
//input sanitizing implemented
//creating letters to be either capitalized or lowercase as input for user